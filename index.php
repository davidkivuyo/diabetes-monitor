...
<body>
    <header class="bg-blue-500 sticky top-0 mx-auto w-full p-4 sm:p-8 flex items-center justify-between gap-4 sm:gap-8">

    <h2 class="font-mono font-bold text-xl object-top-left"><a href="index.html">LOGO</a></h2>
